...
def main():
    # url = "https://acg.gamersky.com/pic/201507/623269_2.shtml"
    # text = start_request(url)
    text = "https://acg.gamersky.com/pic/201507/623269_2.shtml"
    parse(text)
