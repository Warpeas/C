...
#
# Generated by Vivado on Thu Apr 23 14:33:31 CST 2020
...
simulate()
{
  xsim dist_mem_gen_0 -key {Behavioral:sim_1:Functional:dist_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mux2x1.protoinst" -log simulate.log
}
