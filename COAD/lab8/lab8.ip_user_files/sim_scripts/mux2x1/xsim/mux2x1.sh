...
elaborate()
{
  xelab --relax --debug typical --mt auto -L util_vector_logic_v2_0_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mux2x1 xil_defaultlib.mux2x1 xil_defaultlib.glbl -log elaborate.log
}
