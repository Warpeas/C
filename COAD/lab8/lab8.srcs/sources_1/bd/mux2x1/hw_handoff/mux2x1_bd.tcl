...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net s_1 [get_bd_ports s] [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins util_vector_logic_2/Op1]
  ...
  connect_bd_net -net util_vector_logic_3_Res [get_bd_ports c] [get_bd_pins util_vector_logic_3/Res]
